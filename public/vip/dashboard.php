...
<div class="grid grid-2">
    <div class="card">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1.5rem;">
            ...
            <a href="/vip/mes-reservations.php" class="btn btn-secondary">📋 Mes réservations</a>
            <a href="/vip/messagerie.php" class="btn btn-secondary">
                💬 Messagerie
    ...
    <div class="card">
        ...
        <a href="/vip/ma-carte.php" class="btn btn-secondary btn-block" style="margin-top: 1rem;">
                ...
                <tbody>
                    <?php foreach ($prochaines as $res): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/vip/mes-reservations.php" class="btn btn-primary" style="padding: 0.4rem 1rem; font-size: 0.9rem;">
                                    Détails
                                </a>
                            </td>
                        </tr>
...
<?php if ($currentUser['role'] !== 'vip'): ?>
    <div class="card" style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.1) 0%, rgba(255, 107, 53, 0.1) 100%); border-color: var(--gold);">
        <h2 style="color: var(--gold);">⭐ Devenir VIP</h2>
