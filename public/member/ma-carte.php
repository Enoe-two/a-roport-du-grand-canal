...
<div class="card" style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.1) 0%, rgba(255, 107, 53, 0.1) 100%); border-color: var(--gold);">
    ...
    <a href="/member/messagerie.php" class="btn btn-primary btn-block" style="margin-top: 1rem; background: linear-gradient(135deg, var(--gold) 0%, #ffed4e 100%); color: var(--dark);">
