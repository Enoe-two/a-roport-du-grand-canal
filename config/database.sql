-- Base de données Aéroport Minecraft
-- Compatible Railway MySQL

CREATE DATABASE IF NOT EXISTS minecraft_airport CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS taxis (
    ...
    temps_attente INT DEFAULT NULL COMMENT 'En minutes',
    prix_total DECIMAL(10,2) NOT NULL,
    vol_masque TINYINT(1) DEFAULT 0,
    status ENUM('en_attente','confirme','annule','complete') DEFAULT 'en_attente',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Compte admin par défaut (mot de passe: password - À CHANGER !)
